                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center gap-2">
                                                    <!-- View Units Button -->
                                                    <a href="{{ route('units.SuperAdminIndex', ['brandID' => $brand->id, 'categoryID' => $categoryID]) }}" 
                                                    ...
                                                    <form id="delete-form-{{ $brand->id }}" 
                                                          action="{{ route('brands.SuperAdminDestroy', ['id' => $brand->id, 'categoryID' => $categoryID]) }}" 
                                                          method="POST" 
                                                          class="d-inline">
                                                        @csrf
                                                        @method('DELETE')
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            ...
            <div class="modal-body p-4">
                <form id="addBrandForm" action="{{ route('brands.SuperAdminStore', ['categoryID' => $categoryID]) }}" method="POST">
                    @csrf
                    <div class="mb-4">
