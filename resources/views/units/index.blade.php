                ...
                <div class="card-header bg-primary text-white">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            ...
                            <a href="{{ route('brands.index', $categoryID) }}" class="btn btn-light btn-sm ms-2">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            ...
            <div class="modal-body p-4">
                <form id="createUnitForm" action="{{ route('units.store', ['brandID' => $brandID, 'categoryID' => $categoryID]) }}" method="POST">
                    @csrf
                    <div class="mb-4">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.edit-unit-btn').forEach(button => {
            button.addEventListener('click', function() {
                ...
                const formAction = `/units/${unitId}/update/brand/{{ $brandID }}/category/{{ $categoryID }}`;
        ...
        async function checkUnitExists(unitName) {
            try {
                const response = await fetch("{{ route('units.check') }}", {
                    method: 'POST',
                    headers: {
