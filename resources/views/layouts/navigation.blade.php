                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button class="flex items-center space-x-2 text-sm font-medium text-white hover:text-blue-100 transition duration-150 ease-in-out">
                                ...
                                <!-- User Type -->
                                <span class="hidden md:inline-block max-w-[120px] truncate" title="{{ Auth::user()->usertype }}">
                        ...
                        <x-slot name="content">
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                ...
                                <x-dropdown-link 
                                    ...
                                    class="flex justify-center items-center text-gray-700 hover:text-blue-600 transition duration-300 transform hover:scale-105 no-underline"
                                >
