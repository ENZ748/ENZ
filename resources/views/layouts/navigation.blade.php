        ...
        <div class="social-icon">
            ...
            >
                <svg 
                    ...
                    height="1em" 
                    viewBox="0 0 24 24" 
                    :fill="darkMode ? '#FFD700' : '#333'"
                >
                    <path 
                        x-show="!darkMode" 
                        d="M12 3c-4.97 0-9 4.03-9 9s4.03 9 9 9 9-4.03 9-9c0-.46-.04-.92-.1-1.36-.98 1.37-2.58 2.26-4.4 2.26-3.08 0-5.57-2.5-5.57-5.57 0-1.82.89-3.42 2.26-4.4C12.92 3.04 12.46 3 12 3z"
                    />
                    <path 
                        x-show="darkMode" 
                        d="M12 7c-2.76 0-5 2.24-5 5s2.24 5 5 5 5-2.24 5-5-2.24-5-5-5zM2 12.5c-.28 0-.5.22-.5.5s.22.5.5.5h2c.28 0 .5-.22.5-.5s-.22-.5-.5-.5H2zm18 0c-.28 0-.5.22-.5.5s.22.5.5.5h2c.28 0 .5-.22.5-.5s-.22-.5-.5-.5h-2zM12 2c-.28 0-.5.22-.5.5v2c0 .28.22.5.5.5s.5-.22.5-.5v-2c0-.28-.22-.5-.5-.5zm0 18c-.28 0-.5.22-.5.5v2c0 .28.22.5.5.5s.5-.22.5-.5v-2c0-.28-.22-.5-.5-.5zM5.15 4.15c-.2-.2-.51-.2-.71 0l-1.5 1.5c-.2.2-.2.51 0 .71.2.2.51.2.71 0l1.5-1.5c.2-.2.2-.51 0-.71zm12 12c-.2-.2-.51-.2-.71 0l-1.5 1.5c-.2.2-.2.51 0 .71.2.2.51.2.71 0l1.5-1.5c.2-.2.2-.51 0-.71zm-12 0c.2-.2.51-.2.71 0l1.5 1.5c.2.2.2.51 0 .71-.2.2-.51.2-.71 0l-1.5-1.5c-.2-.2-.2-.51 0-.71zm12-12c.2-.2.51-.2.71 0l1.5 1.5c.2.2.2.51 0 .71-.2.2-.51.2-.71 0l-1.5-1.5c-.2-.2-.2-.51 0-.71z"
                    />
                </svg>
            </button>
        </div>
...
<style>
  ...
  body {
    ...
    /* Dark mode styles */
    body.dark {
        background: linear-gradient(to right, #1a2634, #0f2027);
        color: #f4f4f4;
    }
