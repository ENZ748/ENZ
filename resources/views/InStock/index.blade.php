        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse($in_stocks as $in_stock)
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-500 text-center">No items found.</td>
                        </tr>
                @endforelse
            </tbody>  
        </table>
...
<!-- Pagination Links -->
@if($in_stocks->hasPages())
    <div class="mt-4">
        {{ $in_stocks->withQueryString()->links() }}
    </div>
@endif
