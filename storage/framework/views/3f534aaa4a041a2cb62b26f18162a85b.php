...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        <img src="<?php echo e(asset('EnzLogo.png')); ?>" alt="Enz Logo">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('admin.activityLogs')); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\ENZ\resources\views/layouts/superAdminSidebar.blade.php ENDPATH**/ ?>