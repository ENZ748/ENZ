    ...
    <div class="container-fluid px-4">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-end">
                <form action="<?php echo e(route('assigned_items.index')); ?>" method="GET">
                    <div class="input-group" style="width: 450px;">
                        ...
                        <div class="input-group-append">
                            ...
                            <?php if(request('search')): ?>
                                <a href="<?php echo e(route('assigned_items.index')); ?>" class="btn btn-outline-secondary">
        ...
        <div class="mb-4">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                ...
                <span class="badge bg-light text-dark border">
                    <i class="bi bi-collection me-1"></i> Total Records: <?php echo e($assignedItems->total()); ?>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $assignedItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignedItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 transition duration-150">
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                    ...
                                    <small class="text-muted"><?php echo e($assignedItem->employee->department ?? 'N/A'); ?></small>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-500"><?php echo e($assignedItem->employee->employee_number); ?></td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-500" class="text-right">
                                    <div class="btn-group btn-group-sm" role="group">
                                        <button class="btn btn-outline-primary edit-btn" 
                                                ...
                                                data-id="<?php echo e($assignedItem->id); ?>"
                                                data-employee-id="<?php echo e($assignedItem->employeeID); ?>"
                                                data-employee-name="<?php echo e($assignedItem->employee->first_name); ?> <?php echo e($assignedItem->employee->last_name); ?>"
                                                data-category-id="<?php echo e($assignedItem->item->categoryID); ?>"
                                                data-brand-id="<?php echo e($assignedItem->item->brandID); ?>"
                                                data-unit-id="<?php echo e($assignedItem->item->unitID); ?>"
                                                data-serial-number="<?php echo e($assignedItem->item->serial_number); ?>"
                                                data-notes="<?php echo e($assignedItem->notes); ?>"
                                                data-assigned-date="<?php echo e($assignedItem->assigned_date); ?>"
                                                title="Edit">
                                        ...
                                        <button class="btn btn-outline-danger" data-toggle="modal" 
                                                ...
                                                data-id="<?php echo e($assignedItem->id); ?>" 
                                                data-good="<?php echo e(route('assigned_items.good', $assignedItem->id)); ?>" 
                                                data-damaged="<?php echo e(route('assigned_items.damaged', $assignedItem->id)); ?>"
                                                title="Return">
        ...
        <?php if(method_exists($assignedItems, 'hasPages') && $assignedItems->hasPages()): ?>
            <div class="card-footer bg-white">
                <?php echo e($assignedItems->links()); ?>
                            ...
                            <div class="col-md-6">
                                    ...
                                    <select name="employeeID" id="employeeID" class="form-control" required>
                                        ...
                                        <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($emp->id); ?>" 
                                                    data-first-name="<?php echo e($emp->first_name); ?>"
                                                    data-last-name="<?php echo e($emp->last_name); ?>">
                                                <?php echo e($emp->employee_number); ?> - <?php echo e($emp->last_name); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="category" name="category_id" class="form-control" required>
                                        ...
                                        <?php $__currentLoopData = $categoriesWithItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="edit_serial_number" name="serial_number" class="form-control" required>
                                        ...
                                        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($item->id); ?>"><?php echo e($item->serial_number); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.edit-btn').on('click', function() {
                ...
                var modal = $('#editModal');
                modal.find('form').attr('action', '/assigned_items/' + id);
            ...
            $('#category').change(function() {
                ...
                if (categoryId) {
                    $.ajax({
                        url: '/get-brands/create/' + categoryId,
                        type: 'GET',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ENZ\resources\views/assigned_items/index.blade.php ENDPATH**/ ?>