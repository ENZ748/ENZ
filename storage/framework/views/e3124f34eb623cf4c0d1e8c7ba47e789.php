                ...
                <div class="card-header bg-primary text-white py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex">
                            ...
                            <a href="<?php echo e(route('items')); ?>" class="btn btn-light btn-sm ms-2 px-3">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="hover-shadow">
                                            ...
                                            <td class="text-center"><?php echo e(\Carbon\Carbon::parse($category->created_at)->format('M d, Y')); ?></td>
                                            <td class="text-center">
                                                    <div class="d-flex justify-content-center gap-2">
                                                        <!-- View Brands Button -->
                                                        <a href="<?php echo e(route('brands.index', $category->id)); ?>" class="btn btn-sm btn-primary" title="View Brands">
                                                        ...
                                                        <!-- Delete Button -->
                                                        <form class="d-inline" id="delete-form-<?php echo e($category->id); ?>" action="<?php echo e(route('categories.destroy', $category->id)); ?>" method="POST">
                                                            <?php echo csrf_field(); ?>
                                                            <?php echo method_field('DELETE'); ?>
                                                            <button type="button" class="btn btn-sm btn-outline-danger delete-btn" data-id="<?php echo e($category->id); ?>" title="Delete Category">Delete
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            ...
            <div class="modal-body p-4">
                <form id="addCategoryForm" action="<?php echo e(route('categories.store')); ?>" method="POST" onsubmit="return validateCategoryForm(event)">
                    <?php echo csrf_field(); ?>
                    <div class="mb-4">
...
<script>
    ...
    function checkCategoryExists(categoryName, callback) {
        fetch("<?php echo e(route('categories.check')); ?>", {
            method: "POST",
            headers: {
    ...
    document.querySelectorAll('.edit-category-btn').forEach(button => {
        button.addEventListener('click', function () {
            ...
            let formAction = "<?php echo e(route('categories.update', ':id')); ?>".replace(':id', categoryId);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ENZ\resources\views/categories/index.blade.php ENDPATH**/ ?>