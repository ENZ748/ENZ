            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden dashboard-card cursor-pointer h-40" 
                ...
                <div class="p-4 flex items-center h-full">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-2xl font-semibold text-gray-900"><?php echo e($count_admin); ?></p>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <tr class="hover:bg-gray-50 transition duration-150">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                        <div class="d-flex align-items-center">
                                            <div class="avatar-placeholder">
                                                <?php echo e(substr($admin->first_name, 0, 1)); ?><?php echo e(substr($admin->last_name, 0, 1)); ?>

                                            </div>
                                            <div>
                                                <strong><?php echo e($admin->first_name); ?> <?php echo e($admin->last_name); ?></strong><br>
                                                <small class="text-muted"><?php echo e($admin->users->email ?? 'N/A'); ?></small>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-500"><?php echo e($admin->employee_number); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-500"><?php echo e($admin->department); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-500"><?php echo e(date('M d, Y', strtotime($admin->hire_date))); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-500">
                                        <form action="<?php echo e(route('admin.toggleStatus', $admin->id)); ?>" method="POST" class="status-form">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PATCH'); ?>
                                            <button type="button" class="btn btn-sm status-badge <?php echo e($admin->active ? 'btn-success' : 'btn-danger'); ?>"
                                                onclick="confirmStatusChange(this)">
                                                <i class="bi <?php echo e($admin->active ? 'bi-check-circle' : 'bi-x-circle'); ?> me-1"></i>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-500 text-center">
                                        <div class="d-flex justify-content-center gap-2">
                                            <button class="btn btn-sm btn-outline-primary action-btn" onclick="openEditModal(<?php echo e($admin); ?>)">
                                                <i class="bi bi-pencil-square"></i> Edit
                                            </button>
                                            <button class="btn btn-sm btn-outline-secondary action-btn" onclick="openAssignedModal(<?php echo e($admin->id); ?>)">
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500 mb-2"><strong class="font-medium text-gray-700">Current Total:</strong> <?php echo e($count_admin); ?> Admin</p>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="editEmployeeModal" tabindex="-1" aria-labelledby="editEmployeeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editEmployeeForm" method="POST" action="<?php echo e(route('admin.update', $admin->id)); ?>">
                    <?php echo csrf_field(); ?>
...
<script>
    ...
    const dataValues = <?php echo json_encode($values, 15, 512) ?>;
...
<?php echo $__env->make('layouts.superAdminApp', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ENZ\resources\views/superAdminDashboard/index.blade.php ENDPATH**/ ?>