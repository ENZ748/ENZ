                                    ...
                                    <tr class="hover:bg-gray-50 transition duration-150">
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <small class="text-muted"><?php echo e($employee->users->email ?? 'N/A'); ?></small>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-500"><?php echo e($employee->employee_number); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-500"><?php echo e($employee->department); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-500"><?php echo e(date('M d, Y', strtotime($employee->hire_date))); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-500">
                                            <form action="<?php echo e(route('employee.toggleStatus', $employee->id)); ?>" method="POST" class="status-form">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('PATCH'); ?>
                                                <button type="button" class="btn btn-sm status-badge <?php echo e($employee->active ? 'btn-success' : 'btn-danger'); ?>"
                                                    onclick="confirmStatusChange(this)">
                                                    <i class="bi <?php echo e($employee->active ? 'bi-check-circle' : 'bi-x-circle'); ?> me-1"></i>
                                                    <?php echo e($employee->active ? 'Active' : 'Inactive'); ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-500 text-center">
                                            <div class="d-flex justify-content-center gap-2">
                                                <button class="btn btn-sm btn-outline-primary action-btn" onclick="openEditModal(<?php echo e($employee); ?>)">
                                                    <i class="bi bi-pencil-square"></i> Edit
                                                </button>
                                                <button class="btn btn-sm btn-outline-secondary action-btn" onclick="openAssignedModal(<?php echo e($employee->id); ?>)">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addEmployeeForm" method="POST" action="<?php echo e(route('register')); ?>" onsubmit="return confirmAddEmployee(event)">
                        <?php echo csrf_field(); ?>
                        <div class="row g-3">
                            <div class="col-md-6">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ENZ\resources\views/users/index.blade.php ENDPATH**/ ?>