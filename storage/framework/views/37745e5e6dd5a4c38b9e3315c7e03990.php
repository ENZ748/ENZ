<nav x-data="{ open: false }" class="shadow-lg" style="background: linear-gradient(135deg, #0074e8, #005ab4);">
...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                         <?php $__env->slot('trigger', null, []); ?> 
                            <button class="flex items-center space-x-2 text-sm font-medium text-white hover:text-blue-100 transition duration-150 ease-in-out">
                                <div class="relative">
                                ...
                                <!-- User Type -->
                                <span class="hidden md:inline-block max-w-[120px] truncate" title="<?php echo e(Auth::user()->usertype); ?>">
                                <?php echo e(Auth::user()->employees?->first_name ?: 'No employee info'); ?>

                                </span>
                                <svg class="hidden md:inline-block h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
                         ...
                         <?php $__env->slot('content', null, []); ?> 
                            <!-- Account Email -->
                            <div class="block px-4 py-2 text-xs text-gray-400 truncate">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown-link','data' => ['href' => ''.e(route('logout')).'','onclick' => 'event.preventDefault(); this.closest(\'form\').submit();','class' => 'flex justify-center items-center text-gray-700 hover:text-blue-600 transition duration-300 transform hover:scale-105 no-underline']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('logout')).'','onclick' => 'event.preventDefault(); this.closest(\'form\').submit();','class' => 'flex justify-center items-center text-gray-700 hover:text-blue-600 transition duration-300 transform hover:scale-105 no-underline']); ?>
                                    <span class="font-semibold text-center">Log Out</span>
...
<?php endif; ?>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden md:hidden bg-blue-700">
        ...
        <div class="pt-4 pb-1 border-t border-blue-800">
            <div class="px-4">
                ...
                <div class="font-medium text-sm text-blue-200"><?php echo e(Auth::user()->email); ?></div>
            </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.responsive-nav-link','data' => ['href' => route('logout'),'onclick' => 'event.preventDefault(); this.closest(\'form\').submit();','class' => 'text-white hover:bg-blue-600']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('logout')),'onclick' => 'event.preventDefault(); this.closest(\'form\').submit();','class' => 'text-white hover:bg-blue-600']); ?>
...
</style><?php /**PATH C:\xampp\htdocs\ENZ\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>