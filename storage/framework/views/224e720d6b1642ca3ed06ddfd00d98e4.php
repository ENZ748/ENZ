...
<div class="container mx-auto px-10 py-6">
    ...
    <div class="bg-white p-6 rounded-xl shadow-md mb-8">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
            ...
            <!-- Search Form -->
            <form method="GET" action="<?php echo e(route('items.search')); ?>" class="w-full md:w-auto">
                <div class="flex flex-col sm:flex-row gap-2">
                    ...
                    <select name="equipment_status" 
                        ...
                        <option value="0" <?php echo e(request('equipment_status') == '0' ? 'selected' : ''); ?>>Available</option>
                        <option value="1" <?php echo e(request('equipment_status') == '1' ? 'selected' : ''); ?>>In Use</option>
                        <option value="2" <?php echo e(request('equipment_status') == '2' ? 'selected' : ''); ?>>Out of Service</option>
                    </select>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr class="hover:bg-gray-50 transition duration-150">
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"><?php echo e($category); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($brand); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($unit); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 font-mono"><?php echo e($item->serial_number); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 font-mono"><?php echo e($item->quantity); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2 py-1 text-xs font-semibold rounded-full <?php echo e($statusColor); ?>">
                                    <?php echo e($item->equipment_status == 0 ? 'Available' : ($item->equipment_status == 1 ? 'In Use' : 'Out of Service')); ?>

                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($user); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($datePurchased->format('Y-m-d')); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($dateAcquired->format('Y-m-d')); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    <button class="edit-item-btn text-blue-600 hover:text-blue-900 transition duration-200"
                                            ...
                                            data-category="<?php echo e($item->categoryID); ?>" 
                                            data-brand="<?php echo e($item->brandID); ?>" 
                                            data-unit="<?php echo e($item->unitID); ?>" 
                                            data-serial="<?php echo e($item->serial_number); ?>" 
                                            data-quantity="<?php echo e($item->quantity); ?>" 
                                            data-date-purchased="<?php echo e($item->date_purchased); ?>" 
                                            data-date-acquired="<?php echo e($item->date_acquired); ?>">
                                        <i class="fas fa-edit"></i>
                                    </button>

                                    <?php if($item->equipment_status == 2): ?>
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                <div class="p-6">
                    <div class="flex justify-between items-start mb-4">
                        <h3 class="text-lg font-semibold text-gray-800 truncate"><?php echo e($category->category_name); ?></h3>
                        <span class="px-3 py-1 text-xs font-semibold rounded-full <?php echo e($statusConfig['color']); ?>">
                    ...
                    <div class="flex justify-end space-x-2 mt-4 pt-4 border-t border-gray-100">
                        ...
                        <form class="delete-item-form" action="<?php echo e(route('items.destroy', $item->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('DELETE'); ?>
    ...
    <?php if($items instanceof \Illuminate\Pagination\AbstractPaginator && $items->hasPages()): ?>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body p-6">
                    <form action="<?php echo e(route('items.store')); ?>" method="post" id="add-item-form">
                        <?php echo csrf_field(); ?>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="date" id="date_purchased" name="date_purchased" value="<?php echo e(old('date_purchased')); ?>" 
                                    class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" id="date_acquired" name="date_acquired" value="<?php echo e(old('date_acquired')); ?>" 
                                    class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                            </div>
                        </div>
    ...
    <?php endif; ?>
        ...
        <?php if($errors->any()): ?>
            Swal.fire({
                ...
                html: `<?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><p class="text-sm"><?php echo e($error); ?></p><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>`,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ENZ\resources\views/items/index.blade.php ENDPATH**/ ?>