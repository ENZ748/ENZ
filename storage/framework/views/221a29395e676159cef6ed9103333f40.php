                ...
                <div class="card-header bg-primary text-white">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">
                            ...
                            Brands Management - <?php echo e($category ? $category->category_name : 'Uncategorized'); ?>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e(\Carbon\Carbon::parse($brand->created_at)->format('M d, Y')); ?></td>
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center gap-2">
                                                    <!-- View Units Button -->
                                                    <a href="<?php echo e(route('units.index', ['brandID' => $brand->id, 'categoryID' => $categoryID])); ?>" 
                                                    ...
                                                    <form id="delete-form-<?php echo e($brand->id); ?>" 
                                                          action="<?php echo e(route('brands.destroy', ['id' => $brand->id, 'categoryID' => $categoryID])); ?>" 
                                                          method="POST" 
                                                          class="d-inline">
                                                        <?php echo csrf_field(); ?>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            ...
            <div class="modal-body p-4">
                <form id="addBrandForm" action="<?php echo e(route('brands.store', ['categoryID' => $categoryID])); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="mb-4">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        async function checkBrandExists(brandName, categoryId) {
            try {
                const response = await fetch("<?php echo e(route('brands.check')); ?>", {
                    method: 'POST',
                    headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ENZ\resources\views/brands/index.blade.php ENDPATH**/ ?>