    ...
    <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-20 items-center">
            ...
            <div class="flex items-center">
                ...
                <!-- Desktop Navigation Links - Modified to remove lines -->
                <div class="hidden md:flex items-center space-x-1 ml-10">
                    ...
                    <a href="<?php echo e(route('admin.activityLogs')); ?>" 
                       class="px-4 py-2 rounded-lg text-white hover:bg-blue-600/50 transition-all duration-300 flex items-center group border-none focus:border-none focus:outline-none active:border-none">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown-link','data' => ['href' => ''.e(route('logout')).'','onclick' => 'event.preventDefault(); this.closest(\'form\').submit();','class' => 'flex items-center text-gray-700 hover:bg-blue-50 border-t border-gray-100']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('logout')).'','onclick' => 'event.preventDefault(); this.closest(\'form\').submit();','class' => 'flex items-center text-gray-700 hover:bg-blue-50 border-t border-gray-100']); ?>
...
<?php endif; ?>
    ...
    <!-- Mobile Sidebar - Modified to remove lines -->
        ...
        <div class="absolute bottom-0 left-0 right-0 p-4 bg-blue-900">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    ...
                    <div class="text-blue-300 text-xs"><?php echo e(Auth::user()->email); ?></div>
                </div>
            </div>
...
<style>
    ...
    /* Specifically target the dashboard and activity logs links */
    a[href*="dashboard"], 
    a[href*="activityLogs"] {
        border: none !important;
        text-decoration: none !important;
...
</style><?php /**PATH C:\xampp\htdocs\ENZ\resources\views/layouts/nav.blade.php ENDPATH**/ ?>