            ...
            <div class="text-center">
                ...
                <p class="text-lg text-gray-600 max-w-2xl text-center">
                    ...
                    <span class="block text-sm text-gray-500 mt-1">
                        Date and Time Now: 
                        <time id="philippine-time" datetime="<?php echo e(now()->setTimezone('Asia/Manila')->toIso8601String()); ?>">
                            <?php echo e(now()->setTimezone('Asia/Manila')->format('l, F j, Y h:i:s A')); ?>
        ...
        <div class="mb-16 bg-white rounded-2xl shadow-lg overflow-hidden">
                ...
                <div class="flex flex-col md:flex-row md:items-center space-y-4 md:space-y-0 md:space-x-6 mb-4 md:mb-0">
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="bg-blue-100 text-blue-800 text-sm font-semibold px-3 py-1 rounded-full">
                            <?php echo e(count($assigned_items)); ?> Active Items
                        </span>
                        <a href="<?php echo e(route('generatePDF')); ?>" 
            ...
            <?php if(count($assigned_items) > 0): ?>
                ...
                <div id="grid-view" class="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php $__currentLoopData = $assigned_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assigned_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="bg-gradient-to-r from-blue-600 to-indigo-700 px-5 py-4">
                            <div class="flex justify-between items-start">
                                <h3 class="text-lg font-semibold text-white">
                                    <?php echo e($assigned_item->item->category->category_name); ?>
                            ...
                            <p class="text-blue-100 text-sm"><?php echo e($assigned_item->item->brand->brand_name); ?></p>
                        </div>
                        <div class="p-5 space-y-4 bg-white">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="font-medium text-gray-800"><?php echo e($assigned_item->item->serial_number); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="font-medium text-gray-800"><?php echo e(\Carbon\Carbon::parse($assigned_item->assigned_date)->format('M d, Y')); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="mt-4 pt-4 border-t border-gray-100">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-700"><?php echo e($assigned_item->notes); ?></p>
                                    </div>
                                </div>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="mt-4 pt-4 border-t border-gray-100 flex justify-between items-center">
                                <span class="text-xs text-gray-500">Asset ID: <?php echo e($assigned_item->item->id); ?></span>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <?php echo e($assigned_item->item->brand->brand_name); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <?php echo e(\Carbon\Carbon::parse($assigned_item->assigned_date)->format('M d, Y')); ?>
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden mt-12">
                ...
                <div class="flex flex-col md:flex-row md:items-center space-y-4 md:space-y-0 md:space-x-6 mb-4 md:mb-0">
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="bg-green-100 text-green-800 text-sm font-semibold px-3 py-1 rounded-full">
                            <?php echo e(count($history_items)); ?> Returned Items
                        </span>
                        <a href="<?php echo e(route('AssetHistoryGeneratePDF')); ?>" 
            ...
            <?php if(count($history_items) > 0): ?>
                ...
                <div id="history-grid-view" class="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php $__currentLoopData = $history_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="rounded-xl shadow-md overflow-hidden border border-gray-100 transition-all hover:shadow-xl hover:-translate-y-1">
                            <div class="bg-gradient-to-r from-green-600 to-teal-700 px-5 py-4">
                                <div class="flex justify-between items-start">
                                    <h3 class="text-lg font-semibold text-white">
                                        <?php echo e($history_item->item->category->category_name); ?>
                                ...
                                <p class="text-green-100 text-sm"><?php echo e($history_item->item->brand->brand_name); ?></p>
                            </div>
                            <div class="p-5 space-y-4 bg-white">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <p class="text-xs text-gray-500">Serial Number</p>
                                        <p class="font-medium text-gray-800"><?php echo e($history_item->item->serial_number); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <p class="text-xs text-gray-500">Assigned Date</p>
                                        <p class="font-medium text-gray-800"><?php echo e(\Carbon\Carbon::parse($history_item->assigned_date)->format('M d, Y')); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-medium text-gray-800"><?php echo e(\Carbon\Carbon::parse($history_item->created_at)->format('M d, Y')); ?></p>
                                    </div>
                                </div>
                                
                                <?php if($history_item->notes): ?>
                                <div class="mt-4 pt-4 border-t border-gray-100">
                                    <div class="flex items-center space-x-3">
                                        <div class="bg-green-100 p-2 rounded-full">
                                            <svg class="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div>
                                            <p class="text-xs text-gray-500">Notes</p>
                                            <p class="text-sm text-gray-700"><?php echo e($history_item->notes); ?></p>
                                        </div>
                                    </div>
                                </div>
                                <?php endif; ?>
                                ...
                                <div class="mt-4 pt-4 border-t border-gray-100 flex justify-between items-center">
                                    <span class="text-xs text-gray-500">Asset ID: <?php echo e($history_item->item->id); ?></span>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <?php echo e($history_item->item->brand->brand_name); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <?php echo e(\Carbon\Carbon::parse($history_item->assigned_date)->format('M d, Y')); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <?php echo e(\Carbon\Carbon::parse($history_item->created_at)->format('M d, Y')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ENZ\resources\views/adminAccountabilities/index.blade.php ENDPATH**/ ?>