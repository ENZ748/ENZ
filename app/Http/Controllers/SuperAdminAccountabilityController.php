...
class SuperAdminAccountabilityController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('assigned_items.superAdminIndex', compact(
            'assignedItems',
            'employees',
            'categories',
            'categoriesWithItems',
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('superAdminAssigned_items.index')->with('success', 'Item assigned successfully.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('superAdminAssigned_items.index')->with('success', 'Assigned item updated successfully!');
    }
    ...
    //In Stock(Accountability for available items)
        ...
        return redirect()->route('superAdminAssigned_items.index')->with('success', 'Item marked as returned.');
    }
