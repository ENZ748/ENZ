...
class SuperAdminItemController extends Controller
{
    public function index()
    {
        ...
        return view('items.superAdminIndex', compact('items', 'categories','assigned_items'));
    }
    ...
    public function create()
    {
        ...
        $categories = Category::all();
        return view('items.superAdminCreate', compact('categories'));
    }
...
public function store(Request $request)
{
    ...
    public function edit($id)
    {
        ...
        return view('items.superAdminEdit', compact('item', 'categories', 'brands', 'units'));
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('items.superAdminIndex', [
            'items' => $items,
