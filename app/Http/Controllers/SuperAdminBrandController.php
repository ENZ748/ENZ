...
class SuperAdminBrandController extends Controller
{
    public function index($categoryID)
    {
        ...
        return view('brands.superAdminIndex', compact('brands', 'categoryID'));
    }

    // Display the form to create a new category
    public function create($categoryID)
    {
        return view('brands.SuperAdminCreate', compact('categoryID')); // Make sure you have a view for the form
    }
    ...
    public function edit($id, $categoryID)
    {
        ...
        return view('brands.SuperAdminEdit', compact('brand', 'categoryID'));
    }
    ...
    public function destroy($id,$categoryID)
    {
        ...
        return redirect()->route('brands.SuperAdminIndex', ['categoryID' => $categoryID])->with('success', 'Brand Deleted Successfully!');
    }
