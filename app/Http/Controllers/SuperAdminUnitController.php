...
class SuperAdminUnitController extends Controller
{
    public function index($brandID,$categoryID)
    {
        ...
        return view('units.superAdminIndex', compact('units','brandID','categoryID'));
    }
    // Display the form to create a new category
    public function create($brandID,$categoryID)
    {
        return view('units.SuperAdmincreate', compact('brandID','categoryID')); // Make sure you have a view for the form
    }   
    ...
    public function store(Request $request, $brandID, $categoryID)
    {
        ...
        return redirect()->route('units.SuperAdminIndex', ['brandID' => $brandID, 'categoryID' => $categoryID])
    ...
    public function edit($id, $brandID, $categoryID)
    {
        ...
        return view('units.SuperAdminedit', compact('unit', 'brandID', 'categoryID'));
    }
    ...
    public function update(Request $request, $id, $brandID, $categoryID)
    {
        ...
        return redirect()->route('units.SuperAdminIndex', ['id'=>$unit->id, 'brandID'=>$brandID, 'categoryID' => $categoryID])
