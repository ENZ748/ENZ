...
class SuperAdminCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('categories.superAdminIndex', compact('categories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('categories.SuperAdminIndex')->with('success', 'Category created successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('categories.SuperAdminIndex', $category->id)->with('success', 'Category Updated Successfully!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()-> route('categories.SuperAdminIndex')->with('success', 'Item deleted successfully');  
    }
