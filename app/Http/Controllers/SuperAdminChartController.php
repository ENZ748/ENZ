...
class SuperAdminChartController extends Controller
{
    public function index()
    {
        $count_items = Item::count();
        $returned_items = AssignedItem::where('item_status', 'returned')->count();
        return view('superAdminChart.index', compact('count_items', 'returned_items'));
    }
...
return view('superAdminChart.index', compact(
    'yearlyData',
    'currentYear',
    'lastUpdated',
    'count_items',
